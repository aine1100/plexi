    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="bg-white rounded-[40px] border border-black/5 p-8 flex flex-col gap-8 shadow-sm">
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center">
          <div className="h-16 w-16 rounded-2xl bg-black/5 flex items-center justify-center mb-4">
            <Globe className="h-8 w-8 text-[#999]" />
          </div>
          <h3 className="text-[15px] font-black text-[#666] mb-2">Geographic tracking coming soon</h3>
          <p className="text-[13px] font-medium text-[#999] max-w-md">
            Geographic analytics will be available once visitor location tracking is enabled.
            This feature requires adding geo-tracking to your analytics events.
          </p>
        </div>
      </div>
    </div>
